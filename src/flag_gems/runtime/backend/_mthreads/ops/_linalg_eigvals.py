...
def _linalg_eigvals(inp):
    ...
    Real float32 inputs up to 192×192 run the on-device Hessenberg kernel; larger
    matrices and all complex/fp64 inputs fall back to the generic implementation.
    """
